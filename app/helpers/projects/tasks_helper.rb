module Projects::TasksHelper
  def tasks_callout(project)
    if project.tasks.count == 0
      ...
      description << "You can then complete task informations. For estimates, you can enter time in days (e.g., 1d), hours (e.g., 4h) or minutes (e.g., 30m), "
      description << "and of course combine them (e.g., 1d 4h 30m)."
